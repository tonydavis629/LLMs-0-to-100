...
- Self-attention: one sequence looks at itself
- Cross-attention: one sequence supplies Q, another supplies K and V
- Used when text retrieves from an image, audio, a database, or a source sentence in translation

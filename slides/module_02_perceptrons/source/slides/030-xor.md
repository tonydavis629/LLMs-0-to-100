...
A perceptron cuts space with one flat hyperplane. A hidden layer $\sigma(W\mathbf{x}+\mathbf{b})$ **folds** the space itself.

:::note
**Intuition:** a sheet of paper with two colors of dots mixed together.
- One fold stacks same-colored dots
- Then one straight cut separates them
- More folds handle more tangled arrangements
:::

The weight matrix $W$ **is** the fold: it pulls entangled points apart.

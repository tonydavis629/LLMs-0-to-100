...
The course MLP uses **ReLU** in its hidden layer and **sigmoid** on the output (for a probability). <!-- .element: class="text-lg" style="text-align:center; color: var(--muted-color); margin-top: 8px;" -->

<div style="text-align:center; margin-top:4px;">
<svg viewBox="0 0 340 200" width="100%" style="max-height:150px;">
  <defs>
...
- Linear layers collapse into one linear function
- Depth alone gains **nothing**
- The activation between layers is what adds power

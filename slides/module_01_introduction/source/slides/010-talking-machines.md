...
- **Shannon:** communication can be quantified in *bits*
- Any signal can be transmitted reliably through a noisy channel
- **Language is information** with measurable structure
- **Von Neumann:** stored-program architecture enables general computation
...
- Simple pattern matching convinced people it was a **therapist**
...
Data-center spending exceeds the largest 20th-century megaprojects. <!-- .element: class="text-muted" style="font-size: 12pt; text-align: center; margin-top: 8px;" -->
...
- Deep neural network trained on an **NVIDIA GPU**
...
- Removed the sequential bottleneck of RNNs/LSTMs

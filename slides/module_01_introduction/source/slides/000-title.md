...
The course has four module groups: foundations, training, advanced topics, and applications. <!-- .element: class="text-xl course-summary" -->
...
Beyond text, then measuring and shipping. <!-- .element: class="module-track-intro" -->

- **8. Multimodal** &mdash; models that handle text plus images or audio
- **9. Evaluation** &mdash; measuring quality, safety, and failure modes
- **10. Deployment** &mdash; making models fast and reliable in production
...
Real-world systems and research frontiers. <!-- .element: class="module-track-intro" -->

- **11. Applications** &mdash; retrieval-augmented generation (RAG), agents, and tools
...
- Tests your understanding of the lecture material

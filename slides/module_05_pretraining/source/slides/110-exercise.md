...
Open `module_05_pretraining/exercise.py` and fill in the `NotImplementedError` lines. The model is provided; you write the training loop. Run after each step; unfinished steps are skipped. <!-- .element: class="text-lg" -->

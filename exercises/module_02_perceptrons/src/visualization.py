...
Plots decision boundaries and loss curves for the perceptron exercise.
"""
...
def plot_decision_boundary(
    ...
    Args:
        predict_fn: A function that takes a single (2,) array and returns
